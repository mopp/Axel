...
static void init_gdt(void) {
    ...
    /* set_segment_descriptor(gdt + GDT_KERNEL_DATA_INDEX, 0x00200000, 0x00100000, GDT_TYPE_DATA_RWA, GDT_TYPE_FOR_CODE_DATA, GDT_RING0, GDT_PRESENT, GDT_DB_OPSIZE_32BIT, GDT_GRANULARITY_4KB); */
